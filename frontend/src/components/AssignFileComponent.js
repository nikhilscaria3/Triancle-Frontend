...
const AssignedFile = () => {
    ...
    const fetchFiledata = async () => {
        try {
            const response = await axiosInstance.get(`/file/getassignfile?page=${page}&limit=5`, {
                params: {
                    searchQuery,
                    selectedDate
                }
            ...
            if (response) {
                ...
                setFiledata(response.data.assignedfiles);
                                ...
                                <div className="d-flex align-items-center flex-grow-1 justify-content-end  p-4">
                                    <div className="d-flex align-items-center gap-2"> {/* Adjust alignment */}
                                        <TextField
                                            fullWidth
                                            variant="outlined"
                                            placeholder="Search Assigned File..."
                                            value={searchQuery}
